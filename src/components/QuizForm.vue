          ...
          <div class="section right">
            ...
            <div class="form-item">
              ...
              <textarea
                ...
                v-model="quiz.desc"
                :class="{ 'error-desc': errorDesc.status, 'success-desc': successDesc.status }"
              />
              <p v-if="errorDesc.status" class="error-desc-text" >{{errorDesc.text}}</p>
              <p v-if="successDesc.status" class="success-desc-text" >{{successDesc.text}}</p>
            </div>
            <div class="form-item">
              <ul class="items">
                <li class="item">
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      if (this.quiz.desc.length < 6 ){
        this.errorDesc ={
          text: "Look failed! Full Name should be more than 6 characters.",
          status: true
        }
        this.successDesc = {
          text: "",
      ...
      }else if( this.quiz.desc.length >5 ){
        this.successDesc ={
          text: "Look Great!",
          status: true
        }
